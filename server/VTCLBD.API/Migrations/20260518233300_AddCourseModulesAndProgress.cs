...
{
    /// <inheritdoc />
    public partial class AddCourseModulesAndProgress : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResourceLinks_CourseModules_ModuleId",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VideoLessons_CourseModules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "CourseModules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LessonProgresses_VideoLessons_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResourceLinks_ModuleId",
                table: "ResourceLinks",
                column: "ModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_VideoLessons_ModuleId",
                table: "VideoLessons",
                column: "ModuleId");
        }
